...
`,je=({children:t})=>e(Be,{children:t}),Ue=l.p`
  margin: 16px 0;
  font-family: ${h.newYork.medium};
  font-style: normal;
  font-weight: normal;
...
`,O=({children:t,className:i})=>{const n=u("column",i);return e(Ke,{className:n,children:t})},Qe=l.div`
  display: flex;
...
`,et=({children:t})=>e(Qe,{children:t}),tt=({children:t})=>e(O,{className:"is-4",children:t}),$=({children:t,sidebar:i})=>e("main",{className:"main",children:e(V,{children:s(et,{children:[e(O,{children:t}),i&&e(tt,{children:i})]})})}),it=()=>s($,{children:[e("h1",{children:"404 not found"}),e(S,{className:"navbar-item",to:c.Index,children:"Home"})]}),nt=({handleSubmit:t})=>{const[i,n]=L.exports.useState(""),[o,a]=L.exports.useState(""),r=d=>{if(d.preventDefault(),!i||!o){console.log("error PostForm handler");return}t(i,o),console.log("success PostForm handler")};return e("form",{method:"post",onSubmit:d=>r(d),children:s("fieldset",{children:[s("div",{className:"field",children:[e("label",{htmlFor:"title",className:"label",children:"Title"}),e("div",{className:"control",children:e("input",{id:"title",className:"input",type:"text",name:"title",placeholder:'e.g. "More cats for god of cats"',value:i,onChange:d=>{n(d.target.value)}})})]}),s("div",{className:"field",children:[e("label",{htmlFor:"content",className:"label",children:"Content"}),e("div",{className:"control",children:e("textarea",{className:"textarea",name:"content",placeholder:'e.g. "Some content about our godlike cats"',rows:4,value:o,onChange:d=>{a(d.target.value)}})})]}),e("div",{className:"field",children:e("div",{className:"control",children:e("button",{className:"button is-primary",children:"Submit"})})})]})})},R=()=>ee(),Y=te,ot=[],H=ie({name:"posts",initialState:ot,reducers:{postAdded:(t,i)=>{t.push(i.payload)},postRemoved:(t,i)=>t.filter(n=>n.id!==i.payload)}}),{postAdded:st,postRemoved:at}=H.actions;var lt=H.reducer;const rt=()=>{const t=z(),i=R();return s($,{children:[e("h1",{children:"Add post"}),e(nt,{handleSubmit:(o,a)=>{const r={id:ne(),title:o,content:a};i(st(r)),t(c.PostListPage+r.id,{replace:!0})}})]})},ct=({id:t,title:i})=>{const n=u({post:!0,[`post-${t}`]:!0});return e("section",{className:n,children:e("div",{className:"card",children:e("div",{className:"card-content",children:s("div",{className:"media",children:[e("div",{className:"media-content",children:e("p",{className:"title is-4",children:e(S,{to:c.PostListPage+t,children:i})})}),e("div",{className:"media-right"})]})})})})},dt=l.ol`
  && {
    margin-left: 0;
  }
`,mt=l.li`
  list-style: none;
`,pt=({posts:t})=>e(dt,{children:t.map(({id:i,title:n,content:o})=>e(mt,{children:e(ct,{id:i,title:n,content:o})},i))}),ht=()=>{const t=Y(i=>i.posts);return s($,{children:[e("h1",{children:"Blog"}),e(pt,{posts:t})]})},ut=({id:t,title:i,content:n})=>{const o=u({post:!0,[`post-${t}`]:!0});return e("section",{className:o,children:e("div",{className:"card",children:s("div",{className:"card-content",children:[s("div",{className:"media",children:[e("div",{className:"media-content",children:e("p",{className:"title is-4",children:i})}),e("div",{className:"media-right"})]}),e("div",{className:"content",children:n})]})})})},ft=()=>{const{id:t}=oe(),i=z(),n=R(),o=Y(r=>r.posts.find(d=>d.id==t));L.exports.useEffect(()=>{o||i(c.NotFound)},[o]);const a=r=>{n(at(r)),i(c.PostListPage)};return e($,{children:o&&s(w,{children:[e(ut,{id:o.id,title:o.title,content:o.content}),e("button",{className:"button is-danger",onClick:()=>{a(o.id)},children:"Delete"})]})})};var c;(function(t){t.Index="/",t.PostListPage="/posts/",t.PostPage="/posts/:id",t.PostFormPage="/posts/new",t.NotFound="/404",t.WildCard="*"})(c||(c={}));const gt=[{path:c.Index,element:e(Ve,{}),children:[{index:!0,element:e(Je,{})},{path:c.PostListPage,element:e(ht,{})},{path:c.PostPage,element:e(ft,{})},{path:c.PostFormPage,element:e(rt,{})},{path:c.WildCard,element:e(it,{})}]}],xt=()=>{const t=se(gt);return e(w,{children:t})},bt=t=>i=>n=>{const o=i(n);if(console.log("mid"),H.actions.postAdded.match(n)||H.actions.postRemoved.match(n)){const a=t.getState();console.log(a.posts),localStorage.setItem("posts",JSON.stringify(a.posts))}return o},vt=()=>{if(localStorage.getItem("posts")!==null)return{posts:JSON.parse(localStorage.getItem("posts")||"[]")}},Ct=ae({reducer:{posts:lt},preloadedState:vt(),middleware:t=>t().concat(bt)});le.render(e(re.StrictMode,{children:e(ce,{store:Ct,children:e(de,{children:e(xt,{})})})}),document.getElementById("root"));
